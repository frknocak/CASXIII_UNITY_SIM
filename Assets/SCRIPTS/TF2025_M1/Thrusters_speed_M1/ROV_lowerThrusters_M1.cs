...
public class ROV_lowerThrusters_M1 : MonoBehaviour
{
    ...
    float[] values = new float[4];*/ // axis verilerini taklit etmeye çalýþtým ama baþarýlý bir array üretme sýklýðý üretmek uzun sürecek
    void Start()
    {
    ...
    //aslýnda aþaðý yukarý bakma üst thruster'ýun iþi ancak simülasyonda inan fark etmiyor.
