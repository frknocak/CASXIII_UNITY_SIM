...
public class UDP_portTF : MonoBehaviour
{
    ...
    */
    ...
    {
        // byte deðerlerini sbyte olarak yorumlamak
        float x = (float)(sbyte)ints[0];
        float y = (float)(sbyte)ints[1];
        float z = (float)(sbyte)ints[2];
        float h = (float)(sbyte)ints[3];
        float t = (float)(sbyte)ints[4];
        float r = (float)(sbyte)ints[5];
        float k = (float)(sbyte)ints[6];
        //float l = (float)Convert.ToInt32(ints[5]);
        //float m = (float)Convert.ToInt32(ints[6]);
        //x = x - 127;
        //y = y - 127;
        //z = z - 127;
        //h = h - 127;
        //r = r - 127;
        //k = k - 127;
        Debug.Log(string.Format("int: {0} {1} {2} {3} {4}\n", x, y, z, h, t));
        Debug.Log(string.Format("byte: {0} {1} {2} {3} {4}\n", ints[0], ints[1], ints[2], ints[3], ints[4]));
